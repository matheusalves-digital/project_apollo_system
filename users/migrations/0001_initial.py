# Generated by Django 5.0.2 on 2024-02-22 02:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(max_length=11, unique=True, validators=[django.core.validators.MinLengthValidator(limit_value=11)])),
                ('first_name', models.CharField(max_length=30)),
                ('last_login', models.CharField(max_length=30)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('password', models.CharField(max_length=12, validators=[django.core.validators.MinLengthValidator(limit_value=4)])),
